...
Narrative version with figures: `notebooks/ethylene_ladder.ipynb`.
...
Live tables are generated from the saved records in `notebooks/ethylene_ladder.ipynb`; the numbers
